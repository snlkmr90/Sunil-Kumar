                      ...
                      <div class="form-body">
                        <div class="form-group">
                          ...
                          * </span>
                          ...
                          <div class="col-md-10">
                            <?= form_input('post_name', set_value('post_name'), 'class="form-control" placeholder="Enter post Name" '); ?>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-10">
                            ...
                            $options = array(
                                ...
                                'rows' => '2',
                                'cols' => '50',
                                'value'=> set_value('post_meta_title'),
                                'class'=>"form-control"
                            );
                             echo form_textarea($options); ?>
                          </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-10">
                            ...
                            $options = array(
                                ...
                                'rows' => '2',
                                'cols' => '50',
                                'value'=> set_value('post_meta_desc'),
                                'class'=>"form-control"
                            );
                             echo form_textarea($options); ?>
                          </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-10">
                            ...
                            $options = [
                             ...
                             echo form_dropdown('post_status', $options, '1','class="table-group-action-input form-control input-medium"'); ?>
                          </div>
                        </div>
                      </div>
                    </div>
