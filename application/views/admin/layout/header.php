...
<body class="page-header-fixed page-quick-sidebar-over-content <?php if($this->uri->segment(2)=='dashboard'){ echo 'page-sidebar-closed-hide-logo page-container-bg-solid'; } ?>">
  <!-- BEGIN HEADER -->
